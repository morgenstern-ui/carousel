...
function mockNodeOffsets(node: HTMLElement, offsets: TestElementOffsetType): void {
...
export function mockTestElements(dimensions: TestElementDimensionsType): HTMLElement {
